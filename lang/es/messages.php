...
return [
    ...
    'floors' => [
        'created' => 'Planta creada correctamente',
        'updated' => 'Planta actualizada correctamente',
        'deleted' => 'Planta borrada correctamente',
        'error' => [
            'create' => 'Error al crear la planta',
            'update' => 'Error al actualizar la planta',
            'delete' => 'Error al eliminar la planta',
        ],
    ],
    'zones' => [
